...
#define INT64_UINT64
    ...
    IKI_DLLESPEC char* US(iki_svlog_resolve_virtual_method_call)(char* objPtr, int superTypeId, int methodIndex, char* methodSz, char* methodOffsetFromIP, char* methodOffsetFromDP, char* ipToBeUsed, char* DP, char* IP);
